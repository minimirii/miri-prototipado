...
//     version 1.14.0
//     from Assets/Scripts/Action.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/Action.inputactions".
/// </summary>
/// <remarks>
...
public partial class @Action: IInputActionCollection2, IDisposable
{
    ...
    ~@Action()
    {
        UnityEngine.Debug.Assert(!m_Newactionmap.enabled, "This will cause a leak and performance issues, Action.Newactionmap.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_Pajaroscontraseros.enabled, "This will cause a leak and performance issues, Action.Pajaroscontraseros.Disable() has not been called.");
    }
    ...
    public struct NewactionmapActions
    {
        ...
        /// </summary>
        public NewactionmapActions(@Action wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct PajaroscontraserosActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PajaroscontraserosActions(@Action wrapper) { m_Wrapper = wrapper; }
        /// <summary>
